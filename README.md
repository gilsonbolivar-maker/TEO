...
- **Oração** — oito orações curtas para escolher (Pai-Nosso, Serenidade, São Francisco, Salmo 23, antes de estudar ou treinar, gratidão, Santo Anjo, pedido de coragem) e, ao fim da lista, a opção **Outra**, para o usuário escrever a sua. A escolhida fica salva e aparece por inteiro.

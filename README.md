...
- **Uma aba por atividade** — círculo grande, anotação de onde parou e os cinco pontos. Cada ponto pode receber um **horário opcional** (dias da semana e hora de início e fim), e com isso passa a aparecer no relógio da página inicial. A barra de abas rola quando há muitas.

...
- **🎓 Aulas** — um **mostrador circular de 12 horas** no estilo Sectograph: cada aula das próximas doze horas vira um setor colorido no anel, com o ponteiro na hora atual e a legenda das turmas logo abaixo. Sob o mostrador, a data e **em que turma é a aula agora** (com o horário, a sala e quanto falta para terminar) ou qual é a próxima e em quanto tempo. Abaixo, a grade **navegável por semana** (‹ ›), com o dia atual destacado. Uma aula pode ocorrer em **vários dias da semana** — marque quantos precisar ao criar — e vale **toda semana** ou **só na semana exibida**, útil para reposições e aulas avulsas.
